...
<title>Hospital+ | Employee List</title>
			...
			<div class="mother-grid-inner">
				...
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="index.jsp">Home</a><i
						...
						class="fa fa-angle-right"></i> Employee List</li>
				</ol>
				<div class="agile-grids">
					...
					<div class="agile-tables">
						<div class="w3l-table-info">
							...
							<a class="btn btn-blue" style="float: left; margin-bottom: 10px;" href="${pageContext.request.contextPath}/addEmployee">Add Employee+</a>
							<center>OUR CURRENT EMPLOYEE</center>
							...
							<table id="table">
								...
								<tbody>
									...
									<tr>
										...
										<td><center>
											<form method="post" action="${pageContext.request.contextPath}/employeeDetails">
												<input type="hidden" name="view_id" value="${employee.eid}">
										...
										<td><center>
											<form method="post" action="${pageContext.request.contextPath}/employeeDelete">
