...
<html>
	<head>
		<title>Hospital+ | Patients Registration</title>
				...
				<div class="mother-grid-inner">
					...
					<ol class="breadcrumb">
						<li class="breadcrumb-item"><a href="index.jsp">Home</a><i
							class="fa fa-angle-right"></i>Patients <i class="fa fa-angle-right"></i>
							Patients Registration</li>
					</ol>
					<!--grid-->
					<div class="validation-system">
						...
						<div class="validation-form">
							<h3>
								<center>
								    <u>&nbsp;&nbsp;&nbsp;Patients Registration.&nbsp;&nbsp;&nbsp;</u>
								</center>
							</h3>
							
							<p class="form-message">${errorString}</p>
							
							<form action="${pageContext.request.contextPath}/addPatients" method="post">
								...
								<div class="vali-form vali-form1">
									...
									<div class="col-md-6 form-group1 form-last">
										<label class="control-label">Patients Age</label> 
										<input type="text" name="age" placeholder="Enter patients age" required="">
									</div>
									<div class="clearfix"></div>
								</div>
								...
								<div class="vali-form vali-form1">
									...
									<div class="col-md-6 form-group1 form-last">
										...
										<input type="text" name="date" value="${regDate}" required="">
									</div>
									<div class="clearfix"></div>
								</div>
								...
								<div class="vali-form vali-form1">
									<div class="col-md-6 form-group1">
										...
										<input type="text" name="phone_no" placeholder="Enter Phone No." required="">
									</div>
									
									<div class="col-md-6 form-group1 form-last">
									<label class="control-label">Email</label> <input type="email" name="email" 
								...
								<div class="col-md-12 form-group">
									<button type="submit" name="action" class="btn btn-green">&nbsp;Submit&nbsp;</button>
									<button type="reset" class="btn btn-reset">&nbsp; Reset &nbsp;</button>
									<a class="btn btn-blue" href="${pageContext.request.contextPath}/patientsList">View All</a>
								</div>
								<div class="clearfix"></div>
							</form>
